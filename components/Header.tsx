...
const Header = (props: Props) => {
  return (
    <header className="absolute top-0 w-full z-10 ">
      <div className="container mx-auto w-full flex flex-col sm:flex-row items-baseline justify-between text-DarkBrown py-4 sm:py-10 bg-WhiteBG/50 backdrop:blur-md px-16 ">
        <Link href={'/'}>
